    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert">
        ...
        <ul>
          ...
          <li>
            <strong>Programming</strong>: Tutorials, tips, and insights into the
        ...
        <p>
          ...
          invite you to join us on this journey by reading our articles, sharing
          your thoughts, and connecting with us on social media.
        </p>
